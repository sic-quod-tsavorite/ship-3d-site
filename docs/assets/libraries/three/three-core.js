import{U as Tt,c as ir,N as At,S as ar,C as Je,F as xa,V as Be,R as rr,e as Qe,w as Ye,a as pt,l as fi,b as Vn,M as Yt,W as di,d as Pt,f as it,L as en,H as wt,D as bt,B as St,g as an,h as xn,p as or,i as Mn,j as ui,k as sr,m as It,O as Ma,n as Ze,E as lr,o as ht,P as pn,A as cr,q as Ln,r as Ct,s as Xt,t as qt,u as rn,v as Vt,x as vn,y as fr,z as dr,G as on,I as vt,J as Wn,K as zt,Q as Sn,T as ur,X as pr,Y as Qt,Z as hr,_ as mr,$ as _r,a0 as gr,a1 as vr,a2 as Sr,a3 as Er,a4 as xr,a5 as Mr,a6 as Tr,a7 as Ar,a8 as Rr,a9 as br,aa as Cr,ab as Pr,ac as Lr,ad as Dr,ae as Dn,af as fn,ag as Ur,ah as Ht,ai as wr,aj as Ir,ak as ei,al as Nr,am as ti,an as yr,ao as Fr,ap as Or,aq as Br,ar as Fe,as as Gr,at as Hr,au as Nt,av as hn,aw as mn,ax as Vr,ay as Ut,az as tn,aA as Lt,aB as Ta,aC as Wr,aD as Aa,aE as Ra,aF as ba,aG as En,aH as Ca,aI as Pa,aJ as La,aK as Da,aL as kr,aM as zr,aN as Xr,aO as Yr,aP as Ua,aQ as qr,aR as Kr,aS as $r,aT as Un,aU as wn,aV as In,aW as Nn,aX as pi,aY as hi,aZ as mi,a_ as _i,a$ as gi,b0 as vi,b1 as Si,b2 as Ei,b3 as xi,b4 as Mi,b5 as Ti,b6 as Ai,b7 as Ri,b8 as bi,b9 as Ci,ba as Pi,bb as Li,bc as Di,bd as Ui,be as wi,bf as Ii,bg as Ni,bh as yi,bi as Fi,bj as Oi,bk as Bi,bl as Gi,bm as Hi,bn as Vi,bo as Wi,bp as ki,bq as zi,br as kn,bs as zn,bt as Xn,bu as Yn,bv as qn,bw as Kn,bx as $n,by as Zr,bz as Xi,bA as Qr,bB as _n,bC as Jr,bD as Yi,bE as qi,bF as Ki,bG as Zn,bH as Qn,bI as wa,bJ as jr,bK as Tn,bL as eo,bM as to,bN as Ia,bO as Na,bP as $i,bQ as ya,bR as Fa,bS as Oa,bT as Ba,bU as Ga,bV as Ha,bW as Va,bX as Wa,bY as Zi,bZ as ka,b_ as sn,b$ as Kt,c0 as no,c1 as io,c2 as ao,c3 as ro,c4 as Qi,c5 as ut,c6 as oo,c7 as so,c8 as lo,c9 as co,ca as fo,cb as uo,cc as po,cd as ho,ce as mo,cf as _o}from"./three-other.js";function za(){let e=null,n=!1,t=null,i=null;function l(r,h){t(r,h),i=e.requestAnimationFrame(l)}return{start:function(){n!==!0&&t!==null&&(i=e.requestAnimationFrame(l),n=!0)},stop:function(){e.cancelAnimationFrame(i),n=!1},setAnimationLoop:function(r){t=r},setContext:function(r){e=r}}}function go(e){const n=new WeakMap;function t(d,b){const x=d.array,w=d.usage,g=x.byteLength,S=e.createBuffer();e.bindBuffer(b,S),e.bufferData(b,x,w),d.onUploadCallback();let R;if(x instanceof Float32Array)R=e.FLOAT;else if(typeof Float16Array<"u"&&x instanceof Float16Array)R=e.HALF_FLOAT;else if(x instanceof Uint16Array)d.isFloat16BufferAttribute?R=e.HALF_FLOAT:R=e.UNSIGNED_SHORT;else if(x instanceof Int16Array)R=e.SHORT;else if(x instanceof Uint32Array)R=e.UNSIGNED_INT;else if(x instanceof Int32Array)R=e.INT;else if(x instanceof Int8Array)R=e.BYTE;else if(x instanceof Uint8Array)R=e.UNSIGNED_BYTE;else if(x instanceof Uint8ClampedArray)R=e.UNSIGNED_BYTE;else throw new Error("THREE.WebGLAttributes: Unsupported buffer data format: "+x);return{buffer:S,type:R,bytesPerElement:x.BYTES_PER_ELEMENT,version:d.version,size:g}}function i(d,b,x){const w=b.array,g=b.updateRanges;if(e.bindBuffer(x,d),g.length===0)e.bufferSubData(x,0,w);else{g.sort((R,O)=>R.start-O.start);let S=0;for(let R=1;R<g.length;R++){const O=g[S],U=g[R];U.start<=O.start+O.count+1?O.count=Math.max(O.count,U.start+U.count-O.start):(++S,g[S]=U)}g.length=S+1;for(let R=0,O=g.length;R<O;R++){const U=g[R];e.bufferSubData(x,U.start*w.BYTES_PER_ELEMENT,w,U.start,U.count)}b.clearUpdateRanges()}b.onUploadCallback()}function l(d){return d.isInterleavedBufferAttribute&&(d=d.data),n.get(d)}function r(d){d.isInterleavedBufferAttribute&&(d=d.data);const b=n.get(d);b&&(e.deleteBuffer(b.buffer),n.delete(d))}function h(d,b){if(d.isInterleavedBufferAttribute&&(d=d.data),d.isGLBufferAttribute){const w=n.get(d);(!w||w.version<d.version)&&n.set(d,{buffer:d.buffer,type:d.type,bytesPerElement:d.elementSize,version:d.version});return}const x=n.get(d);if(x===void 0)n.set(d,t(d,b));else if(x.version<d.version){if(x.size!==d.array.byteLength)throw new Error("THREE.WebGLAttributes: The size of the buffer attribute's array buffer does not match the original size. Resizing buffer attributes is not supported.");i(x.buffer,d,b),x.version=d.version}}return{get:l,remove:r,update:h}}var vo=`#ifdef USE_ALPHAHASH
...
#define LOW_PRECISION`),n}const Rf={[mn]:"SHADOWMAP_TYPE_PCF",[tn]:"SHADOWMAP_TYPE_VSM"};function bf(e){return Rf[e.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Cf={[sn]:"ENVMAP_TYPE_CUBE",[Kt]:"ENVMAP_TYPE_CUBE",[Tn]:"ENVMAP_TYPE_CUBE_UV"};function Pf(e){return e.envMap===!1?"ENVMAP_TYPE_CUBE":Cf[e.envMapMode]||"ENVMAP_TYPE_CUBE"}const Lf={[Kt]:"ENVMAP_MODE_REFRACTION"};function Df(e){return e.envMap===!1?"ENVMAP_MODE_REFLECTION":Lf[e.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Uf={[po]:"ENVMAP_BLENDING_MULTIPLY",[uo]:"ENVMAP_BLENDING_MIX",[fo]:"ENVMAP_BLENDING_ADD"};function wf(e){return e.envMap===!1?"ENVMAP_BLENDING_NONE":Uf[e.combine]||"ENVMAP_BLENDING_NONE"}function If(e){const n=e.envMapCubeUVHeight;if(n===null)return null;const t=Math.log2(n)-2,i=1/n;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function Nf(e,n,t,i){const l=e.getContext(),r=t.defines;let h=t.vertexShader,d=t.fragmentShader;const b=bf(t),x=Pf(t),w=Df(t),g=wf(t),S=If(t),R=gf(t),O=vf(r),U=l.createProgram();let f,o,P=t.glslVersion?"#version "+t.glslVersion+`
